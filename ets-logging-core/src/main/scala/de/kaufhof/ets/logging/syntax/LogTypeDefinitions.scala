...
trait LogTypeDefinitions[E] {
  ...
  final type Decomposed = generic.LogDecomposed[Encoded]
  final type PredefKeys = generic.LogPredefKeys[Encoded]
  final type Attribute = generic.LogAttribute[Encoded]
  final type Decomposer[-I] = generic.LogEncoder[I, Decomposed]
  ...
  final type Composite = generic.LogDecomposed[Encoded]
